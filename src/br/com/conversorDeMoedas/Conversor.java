...
import br.com.conversorDeMoedas.modelos.DadosConversao;
...
public class Conversor {
    ...
    public Conversor(){
        ...
        retorno = api.consultaRota("https://v6.exchangerate-api.com/v6/766ba9854cf3f93e8ec4a905/codes");

        FormataConsulta formata = new FormataConsulta();
        DadosMoeda moedas = formata.consultaToJson(retorno, DadosMoeda.class);
    ...
    public void converterDePara(){
        ...
        retorno = api.consultaRota("https://v6.exchangerate-api.com/v6/766ba9854cf3f93e8ec4a905/pair/"+moedaDe+"/"+moedaPara);

        FormataConsulta formata = new FormataConsulta();
        DadosConversao conversao = formata.consultaToJson(retorno, DadosConversao.class);
